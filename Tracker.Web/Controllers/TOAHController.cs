        ...
        public ActionResult Table()
        {
            ...
            using (var db = new Database(settings.DbType, settings.DbConnection))
            {
                DtResponse response  = new Editor(db, "Order","Id")
                    ...
                    .Field(new Field("Order.Id").Options(new Options()
                        .Table("Order")
                    .Value("Id")))
                    .Field(new Field("Order.RequestItems").Options(new Options()
                        .Table("Order")
                    .Value("RequestItems")))
                    .Field(new Field("Order.InventoryItem1").Options(new Options()
                        .Table("Order")
                    .Value("InventoryItem1")))
                    .Field(new Field("Order.InventoryItem2").Options(new Options()
                        .Table("Order")
                    .Value("InventoryItem2")))
                    .Field(new Field("Order.InventoryItem3").Options(new Options()
                        .Table("Order")
                    .Value("InventoryItem3")))
                    .Field(new Field("Order.InventoryItem4").Options(new Options()
                        .Table("Order")
                    .Value("InventoryItem4")))
                    .Field(new Field("Client.email").Set( false ))
